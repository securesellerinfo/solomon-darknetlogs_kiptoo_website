    ...
    <div>
      <div className="addfundspage">
        ...
        <div className="make_payment_div">
          ...
          <div>
            <input type="text" value="3LCJuS5WGrAGcqNezF45yqLizhaoq1CtkS" />
          </div>
          <CopyToClipboard text="3LCJuS5WGrAGcqNezF45yqLizhaoq1CtkS">
            <button>Copy</button>
          </CopyToClipboard>
          <h5>
        ...
        <div className="addfunds_footer">
          ...
          <p className="footer_addfunds_page">
            Darknetlogs ® | Copyright © 2022 , All rights reserved. 2017 - 2022
          </p>
        </div>
      </div>
    </div>
